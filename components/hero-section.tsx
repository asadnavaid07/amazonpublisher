...
//               <Button size="lg" className="bg-primary mt-3 hover:bg-primary/90 text-primary-foreground group">
//                 Get started
//                 <ArrowRight className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" />
//               </Button>
//               <div className="relative inline-flex items-center gap-3 select-none">
//                 <button className="relative grid place-items-center w-12 h-12 rounded-full bg-secondary border border-border ">
//                   <Play className="w-4 h-4" />
//                 </button>
//                 <div className="relative w-16 h-16">
//                   <div className="absolute inset-0 rounded-full border border-border grid place-items-center text-[8px] uppercase tracking-wider spin-slow">
//                     <span>• See demo •  </span>
//                   </div>
//                 </div>
//               </div>
...
//             {/* Row 1 */}
//             <div className="relative overflow-hidden rounded-[36px] border border-border/80 bg-card/60 backdrop-blur">
...
//                 {["/fantasy-book-cover-midnight.jpg","/sci-fi-book-cover-futuristic.jpg","/romance-book-cover-garden.jpg","/mystery-book-cover-harbor.jpg","/book-cover-wellness.jpg"].map((src, i) => (
//                   <div key={`r1-"${'${i}'}"`} className="shrink-0 w-64 md:w-72 my-3 mr-4 rounded-[24px] overflow-hidden border border-border bg-white shadow-md">
//                     <Image src={src} alt="Book cover" width={600} height={800} className="w-full h-40 md:h-48 object-cover" />
//                   </div>
//                 ))}
//                 {["/fantasy-book-cover-midnight.jpg","/sci-fi-book-cover-futuristic.jpg","/romance-book-cover-garden.jpg","/mystery-book-cover-harbor.jpg","/book-cover-wellness.jpg"].map((src, i) => (
//                   <div key={`r1b-"${'${i}'}"`} className="shrink-0 w-64 md:w-72 my-3 mr-4 rounded-[24px] overflow-hidden border border-border bg-white shadow-md">
//                     <Image src={src} alt="Book cover" width={600} height={800} className="w-full h-40 md:h-48 object-cover" />
//                   </div>
//                 ))}
//               </div>
...
//             {/* Row 2 */}
//             <div className="mt-5 relative overflow-hidden rounded-[36px] border border-border/80 bg-card/60 backdrop-blur">
//               <div className="pointer-events-none absolute left-0 top-0 h-full w-24 bg-gradient-to-r from-background to-transparent z-10" />
//               <div className="pointer-events-none absolute right-0 top-0 h-full w-24 bg-gradient-to-l from-background to-transparent z-10" />
//               <div className="flex gap-4 w-[200%] animate-slide-reverse">
//                 {["/book-cover-literature.jpg","/book-cover-technology.jpg","/adventure-book-cover.png","/fantasy-book-cover-midnight.jpg","/romance-book-cover-garden.jpg"].map((src, i) => (
//                   <div key={`r2-"${'${i}'}"`} className="shrink-0 w-64 md:w-72 my-3 mr-4 rounded-[24px] overflow-hidden border border-border bg-white shadow-md">
//                     <Image src={src} alt="Book cover" width={600} height={800} className="w-full h-40 md:h-48 object-cover" />
//                   </div>
//                 ))}
//                 {["/book-cover-literature.jpg","/book-cover-technology.jpg","/adventure-book-cover.png","/fantasy-book-cover-midnight.jpg","/romance-book-cover-garden.jpg"].map((src, i) => (
//                   <div key={`r2b-"${'${i}'}"`} className="shrink-0 w-64 md:w-72 my-3 mr-4 rounded-[24px] overflow-hidden border border-border bg-white shadow-md">
//                     <Image src={src} alt="Book cover" width={600} height={800} className="w-full h-40 md:h-48 object-cover" />
//                   </div>
//                 ))}
//               </div>
...
//             {/* Row 1 */}
//             <div className="relative overflow-hidden rounded-[36px] border-4 border-primary/80 bg-black backdrop-blur shadow-[0_0_30px_rgba(236,162,18,0.15)]">
//               {/* <div className="pointer-events-none absolute left-0 top-0 h-full w-32 bg-gradient-to-r from-background via-background/80 to-transparent z-10" />
//               <div className="pointer-events-none absolute right-0 top-0 h-full w-32 bg-gradient-to-l from-background via-background/80 to-transparent z-10" /> */}
//               <div className="flex gap-4 w-[200%] animate-slide">
//                 {["/fantasy-book-cover-midnight.jpg","/sci-fi-book-cover-futuristic.jpg","/romance-book-cover-garden.jpg","/mystery-book-cover-harbor.jpg","/book-cover-wellness.jpg"].map((src, i) => (
...
//             {/* Row 2 */}
//             <div className="mt-5 relative overflow-hidden rounded-[36px] border-4 border-primary/80 bg-white backdrop-blur shadow-[0_0_30px_rgba(236,162,18,0.15)]">
//               {/* <div className="pointer-events-none absolute left-0 top-0 h-full w-32 bg-gradient-to-r from-background via-background/80 to-transparent z-10" />
//               <div className="pointer-events-none absolute right-0 top-0 h-full w-32 bg-gradient-to-l from-background via-background/80 to-transparent z-10" /> */}
//               <div className="flex gap-4 w-[200%] animate-slide-reverse">
//                 {["/book-cover-literature.jpg","/book-cover-technology.jpg","/adventure-book-cover.png","/fantasy-book-cover-midnight.jpg","/romance-book-cover-garden.jpg"].map((src, i) => (
