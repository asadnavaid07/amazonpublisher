...
//         {/* Floating orbs */}
//         <div className="absolute top-1/4 left-10 w-80 h-80 bg-[#ECA212]/10 rounded-full blur-3xl animate-pulse"></div>
//         <div className="absolute bottom-1/4 right-10 w-96 h-96 bg-[#D89010]/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
//       </div>
...
//                   <div className="absolute -inset-0.5 bg-gradient-to-r from-[#ECA212] to-[#D89010] rounded-2xl opacity-0 group-hover:opacity-30 blur transition duration-500"></div>
                  
//                   {/* Card */}
//                   <div className="relative h-full bg-white/90 backdrop-blur-sm border border-gray-200 rounded-2xl p-6 hover:border-[#ECA212]/50 transition-all duration-300 hover:shadow-xl hover:shadow-[#ECA212]/20 hover:scale-105">
//                     <div className="flex flex-col h-full">
//                       <div>
//                         <div className="mb-4 inline-block p-3 bg-[#ECA212]/10 rounded-lg group-hover:bg-[#ECA212]/20 transition-colors duration-300">
//                           <Icon className="w-6 h-6 text-[#ECA212] group-hover:scale-110 transition-transform duration-300" />
//                         </div>
//                         <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-[#ECA212] transition-colors duration-300">
//                           {service.title}
//                         </h3>
