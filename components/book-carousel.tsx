...
//   return (
//     <section className="relative min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-amber-50 via-yellow-50 to-orange-50 py-20 overflow-hidden">
//       {/* ---------- Header ---------- */}
//       <motion.div
...
//           {/* ---- Prev preview (desktop) ---- */}
//           <div className="hidden lg:block">
//             <motion.div
//               whileHover={{ scale: 1.05 }}
//               className="w-48 h-72 rounded-xl overflow-hidden shadow-lg border border-yellow-200"
//             >
//               <img src={prevBook.cover} alt={prevBook.title} className="w-full h-full object-cover" />
//             </motion.div>
//           </div>
...
//               >
//                 {/* Front face */}
//                 <div className="absolute inset-0 backface-hidden rounded-2xl overflow-hidden shadow-2xl border border-yellow-300">
//                   <img
//                     src={books[currentIndex].cover}
//                     alt={books[currentIndex].title}
//                     className="w-full h-full object-cover"
//                   />
//                   <div className="absolute inset-0 bg-gradient-to-t from-yellow-900/70 via-transparent to-transparent" />
...
//                 {/* Back face (info) */}
//                 <div className="absolute inset-0 backface-hidden rotate-y-180 bg-white/95 backdrop-blur-sm p-6 flex flex-col justify-center rounded-2xl shadow-2xl border border-yellow-300">
//                   <span className="inline-block px-3 py-1 bg-gradient-to-r from-yellow-400 to-orange-400 text-yellow-900 rounded-full text-xs font-bold mb-3">
//                     {books[currentIndex].genre}
//                   </span>
//                   <h3 className="text-2xl font-bold text-yellow-800 mb-1">
//                     {books[currentIndex].title}
//                   </h3>
//                   <p className="text-sm text-amber-700 mb-3">by {books[currentIndex].author}</p>
//                   <p className="text-sm text-amber-800 line-clamp-4">{books[currentIndex].description}</p>

//                   <div className="mt-5 flex gap-3">
//                     <Button className="bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 text-yellow-900 font-semibold shadow-md">
//                       Read More
//                     </Button>
...
//         {/* ---- Navigation ---- */}
//         <div className="flex justify-center gap-4 mt-12">
//           <Button onClick={prev} variant="outline" size="icon" className="border-yellow-400 text-yellow-600 hover:bg-yellow-50">
//             <ChevronLeft className="w-5 h-5" />
//           </Button>
//           <Button onClick={next} variant="outline" size="icon" className="border-yellow-400 text-yellow-600 hover:bg-yellow-50">
//             <ChevronRight className="w-5 h-5" />
//           </Button>
//         </div>
...
//                 i === currentIndex
//                   ? "bg-gradient-to-r from-yellow-400 to-orange-500 w-10 h-3 shadow"
//                   : "bg-amber-300 w-3 h-3 hover:bg-yellow-400"
//               }`}
//             />
//           ))}
//         </div>
...
//             className="text-sm font-medium text-amber-700 hover:text-yellow-600 flex items-center gap-1"
//           >
//             <span>{isAutoPlay ? "Pause" : "Play"}</span>
//             <span className="text-lg">{isAutoPlay ? "Pause" : "Play"}</span>
//           </button>
//         </div>
//       </div>
//     </section>
