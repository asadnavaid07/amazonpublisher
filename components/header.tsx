...
import HeaderClient from "@/components/client-side/header";

export default function Header() {
  // Data defined on the server (or fetched from a database/CMS)
  const navItems = [
    { label: "Services", href: "/services", hasDropdown: true },
    { label: "Blogs", href: "/blogs" },
    { label: "About", href: "/about-us" },
  ...
  return (
    <>
      {/* Top Warning Banner - Static HTML rendered on Server */}
      <div className="w-full bg-gradient-to-r from-[#ECA212] to-[#D89010] text-white py-2.5 px-4 text-center text-sm font-medium z-[9999]">
        <span className="inline-block">
          <strong>Important:</strong> Fraudulent sites are impersonating Amazon
          Author Partners. The only official website is{" "}
      ...
      {/* Client Component containing interactivity and scroll logic */}
      <HeaderClient navItems={navItems} serviceItems={serviceItems} />
    </>
  );
}