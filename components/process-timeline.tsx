...
//         {/* Floating Orbs */}
//         <div className="absolute top-10 left-10 w-80 h-80 bg-gradient-to-br from-yellow-300 to-orange-300 rounded-full blur-3xl opacity-40 animate-float"></div>
//         <div className="absolute bottom-20 right-10 w-72 h-72 bg-gradient-to-br from-pink-300 to-purple-300 rounded-full blur-3xl opacity-40 animate-float-delayed"></div>
//       </div>
...
//             <div className="flex gap-6 items-center animate-carousel-scroll">
...
//                     <div
//                       key={`${setIndex}-${num}`}
//                       className="flex-shrink-0 group cursor-pointer transition-transform duration-300 hover:scale-110 hover:-translate-y-2"
//                     >
...
//                                 ['pink-400', 'rose-500'],
//                                 ['purple-400', 'indigo-500'],
//                                 ['teal-400', 'cyan-500'],
//                                 ['orange-400', 'red-500']
//                               ];
//                               const [from, to] = colors[num % 5];
//                               e.currentTarget.parentElement!.innerHTML = `<div class="flex flex-col items-center justify-center w-full h-full bg-gradient-to-br from-${from} to-${to}"><div class="text-6xl mb-3">📖</div><div class="text-white font-bold text-lg">Book ${num}</div></div>`;
//                             }}
//                           />
//                         </div>
//                         {/* Shine effect */}
//                         <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent animate-shine" style={{ animationDelay: `${num * 0.3}s` }}></div>
...
//         {/* Header */}
//         <div className={`text-center mb-20 transition-all duration-800 ${hasAnimated ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
...
//                 {/* Icon */}
//                 <div className="relative z-10 flex-shrink-0 transition-transform duration-300 hover:scale-125 hover:rotate-12">
...
//                     </div>
//                   </div>
//                   <div className={`absolute inset-0 rounded-full bg-gradient-to-br ${step.gradient} blur-xl opacity-70 -z-10 animate-icon-pulse`} style={{ animationDelay: `${index * 0.3}s` }} />
//                 </div>

//                 {/* Card */}
//                 <div
//                   onClick={() => setExpandedStep(expandedStep === step.number ? null : step.number)}
//                   className={`flex-1 bg-gradient-to-br ${step.gradient} ${step.bgOpacity} backdrop-blur-xl border-2 border-white/30 rounded-3xl p-6 cursor-pointer shadow-xl hover:shadow-2xl hover:${step.glow} hover:-translate-y-2 hover:scale-105 transition-all duration-400`}
//                 >
...
//                       style={{ transform: expandedStep === step.number ? 'rotate(180deg)' : 'rotate(0deg)' }}
//                     >
...
//         {/* Final CTA */}
//         <div className={`mt-20 p-10 rounded-3xl bg-gradient-to-br from-yellow-400 via-pink-400 to-purple-500 shadow-2xl relative overflow-hidden transition-all duration-800 ${
...
export default function ProcessTimeline() {
  ...
  return (
    <section id="process" className="py-24 relative overflow-hidden">
          ...
          {steps.map((step) => (
            <div key={step.number} className="relative">
              ...
              <div className="flex items-start gap-6 group">
                ...
                <div
                  onClick={() => setExpandedStep(expandedStep === step.number ? null : step.number)}
                  className={`flex-1 bg-gradient-to-br ${step.gradient} ${step.bgOpacity} backdrop-blur-xl border-2 border-white/30 rounded-3xl p-6 cursor-pointer shadow-xl hover:shadow-2xl hover:${step.glow} hover:-translate-y-0 hover:scale-105 transition-all duration-400`}
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-3">
      ...
      {/* Only Carousel & Shine animations retained */}
      <style jsx>{`
        @keyframes carousel-scroll {
          0% { transform: translateX(0); }
          100% { transform: translateX(-1200px); }
